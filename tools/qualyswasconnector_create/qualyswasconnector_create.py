...
class qualysvmcreate:
    ...
    def __init__(self):
        ...
        try:
            connector_details=self.rs.connectors.create_qualys_was(self.connector_name,self.connectorurl,self.scheduletype,self.networkid,self.username,self.password,auto_urba=False,hour_of_day=self.hourofday,reportnameprefix=self.reportnameprefix)
