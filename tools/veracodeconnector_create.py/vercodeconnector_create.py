...
class veracodecreate:
    ...
    def __init__(self):
        ...
        a=self.rs.connectors.create_veracode(self.connector_name,self.connectorurl,self.scheduletype,self.networkid,self.username,self.password,auto_urba=False,authmechanism=self.authmechanism)
        print(a)
