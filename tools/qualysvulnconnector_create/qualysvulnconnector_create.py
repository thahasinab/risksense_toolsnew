...
class qualysvulncreate:
    ...
    def __init__(self):
        ...
        try:
            connector_details=self.rs.connectors.create_qualys_vuln(self.connector_name,self.connectorurl,self.scheduletype,self.networkid,self.username,self.password,auto_urba=False,hour_of_day=self.hourofday)
